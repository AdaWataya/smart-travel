...
public class Post extends AsyncTask<String, Void, String> {
    ...
    @Deprecated
    public Post(AsyncResponse asyncResponse){
        this.asyncResponse = asyncResponse;
        this.context = (Context) asyncResponse;
    }

    @Deprecated
    public Post(AsyncResponse asyncResponse, HashMap<String, String> postData){
        this.asyncResponse = asyncResponse;
        this.context = (Context) asyncResponse;
        this.postData = postData;
    }
    ...
    @Deprecated
    public Post(AsyncResponse asyncResponse, String loadingMessage){
        this.asyncResponse = asyncResponse;
        this.context = (Context) asyncResponse;
        this.loadingMessage = loadingMessage;
    }
    ...
    @Deprecated
    public Post(AsyncResponse asyncResponse, HashMap<String, String> postData, String loadingMessage){
        this.asyncResponse = asyncResponse;
        this.context = (Context) asyncResponse;
        this.postData = postData;
        this.loadingMessage = loadingMessage;

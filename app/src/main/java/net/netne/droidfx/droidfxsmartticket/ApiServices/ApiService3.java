...
public interface ApiService3 {
    @FormUrlEncoded
    @POST("event.php")
    Call<InsertDataResponseModel> insertData(@Field("device") String device, @Field("bus") String bus, @Field("route") String route, @Field("driver") String driver, @Field("event") String event, @Field("loc") String loc);
}

 ...
 */
public class PostResponse extends AsyncTask<String, Void, String> {
    ...
    private String loadingMessage = "Erasing record...";
    ...
    @Deprecated
    public PostResponse(AsyncResponse asyncResponse){
        this.asyncResponse = asyncResponse;
        this.context = (Context) asyncResponse;
    }

    @Deprecated
    public PostResponse(AsyncResponse asyncResponse, HashMap<String, String> postData){
        this.asyncResponse = asyncResponse;
        this.context = (Context) asyncResponse;
        this.postData = postData;
    }
    ...
    @Deprecated
    public PostResponse(AsyncResponse asyncResponse, String loadingMessage){
        this.asyncResponse = asyncResponse;
        this.context = (Context) asyncResponse;
        this.loadingMessage = loadingMessage;
    }
    ...
    @Deprecated
    public PostResponse(AsyncResponse asyncResponse, HashMap<String, String> postData, String loadingMessage){
        this.asyncResponse = asyncResponse;
        this.context = (Context) asyncResponse;
        this.postData = postData;
        this.loadingMessage = loadingMessage;

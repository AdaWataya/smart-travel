...
import net.netne.droidfx.droidfxsmartticket.NFCWriteException.NFCErrorType;
...
public class Format {
    ...
    Format.TagReadListener onTagReadListener;
    Format.TagWriteListener onTagWriteListener;
    Format.TagWriteErrorListener onTagWriteErrorListener;

    String writeText = null;


    public Format(Activity activity) {
     ...
     */
    public void setOnTagReadListener(Format.TagReadListener onTagReadListener) {
     ...
     */
    public void setOnTagWriteListener(Format.TagWriteListener onTagWriteListener) {
     ...
     */
    public void setOnTagWriteErrorListener(Format.TagWriteErrorListener onTagWriteErrorListener) {
    ...
    private void readTagFromIntent(Intent intent) {
       ...
       try{ if (NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action)) {

...
public class Stamp {
    ...
    Stamp.TagReadListener onTagReadListener;
    Stamp.TagWriteListener onTagWriteListener;
    Stamp.TagWriteErrorListener onTagWriteErrorListener;

    String writeText = null;


    public Stamp(Activity activity) {
     ...
     */
    public void setOnTagReadListener(Stamp.TagReadListener onTagReadListener) {
     ...
     */
    public void setOnTagWriteListener(Stamp.TagWriteListener onTagWriteListener) {
     ...
     */
    public void setOnTagWriteErrorListener(Stamp.TagWriteErrorListener onTagWriteErrorListener) {

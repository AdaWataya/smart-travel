 ...
 */
public class PostResponseAsyncTask2 extends AsyncTask<String, Void, String> {
    ...
    private HashMap<Double, Double> postDat = new HashMap<Double, Double>();
    private String loadingMessage = "Checking...";
    ...
    //Valid Constructor
    public PostResponseAsyncTask2(Context context,
    ...
    protected void onPostExecute(String result) {
        ...
        if(asyncResponse != null){
            asyncResponse.processPin(result);
        }
    ...
    @Deprecated
    public PostResponseAsyncTask2(AsyncResponse asyncResponse){
        this.asyncResponse = asyncResponse;
        this.context = (Context) asyncResponse;
    }

    @Deprecated
    public PostResponseAsyncTask2(AsyncResponse asyncResponse, HashMap<String, String> postData){
        this.asyncResponse = asyncResponse;
        this.context = (Context) asyncResponse;
        this.postData = postData;
    }
    ...
    @Deprecated
    public PostResponseAsyncTask2(AsyncResponse asyncResponse, String loadingMessage){
        this.asyncResponse = asyncResponse;
        this.context = (Context) asyncResponse;
        this.loadingMessage = loadingMessage;
    }
    ...
    @Deprecated
    public PostResponseAsyncTask2(AsyncResponse asyncResponse, HashMap<String, String> postData, String loadingMessage){
        this.asyncResponse = asyncResponse;
        this.context = (Context) asyncResponse;
        this.postData = postData;
        this.loadingMessage = loadingMessage;
